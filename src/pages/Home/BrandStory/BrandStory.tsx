...
export const BrandStory = () => {
  return (
    <div className="relative w-full h-[956px] grid place-content-center overflow-hidden">
      ...
      <div className="z-10 h-full w-full">
        <div className="text-ct-yellow-color text-center">
          <div className="text-4xl uppercase font-bold tracking-[4.5px]">Brand Story</div>
          <div className="leading-7 w-[720px] mx-auto mt-10 mb-16">
            모바일에 최적화된 비디오를 단 몇 분 만에 제작해보세요. 디자이너가 아니더라도,  모든 팀에서
            다듬을 수 있습니다. 브랜드의 성공을 위한 첫 걸음을  내딛어보세요. 비디오를 단 몇 분 만에 제작해보세요.
          </div>
        </div>
        <div className="grid w-max grid-cols-2">
          <div className="col-span-2 h-6 w-full bg-ct-black-color-bold px-2 flex flex-col justify-evenly">
            <div className="bg-ct-blue-color min-h-[2px] h-[2px] w-full"></div>
            <div className="bg-ct-blue-color min-h-[2px] h-[2px] w-full"></div>
          </div>
          <div className="w-[612px] col-span-1">
            <ResponsiveImage className='' src={imgStory} src2x={imgStory2x} src3x={imgStory3x} alt="imgStory" />
          </div>
          <div className="col-span-1 bg-white border-4 border-l-0 border-ct-border-color">
            <div className="flex w-full h-full flex-col justify-evenly p-10 text-ct-black-color-normal">
              <div className="font-extrabold uppercase text-2xl">What Happened’s Brand story</div>
              <div className="w-[500px] leading-7">
